...
//Function to retrieve messages and display them
...
document.getElementById("image4").addEventListener("click", function () {
    showPopup(`I have a big immediate family—it’s me, my parents, a younger sister, and an older brother and sister. My entended family is also massive with countless cousins, aunts and uncles.`);
});
